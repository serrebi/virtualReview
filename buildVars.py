...
addon_info = {
	...
	"addon_url": "https://github.com/serrebi/virtualReview",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/serrebi/virtualReview",
...
pythonSources = ["addon/globalPlugins/virtualRevision.py",]
